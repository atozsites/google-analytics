 ...
 * Plugin URI: https://github.com/atozsites/google-analytics/
 * Description: Easily integrate <a href="http://analytics.google.com">Google Analytics</a> with WordPress to track website statistics
 * Version: 1.4.1
 * Author: Atozsites
...
/**
 * GoogleAnalytics is the class that handles ALL of the plugin functionality.
 * It helps us avoid name collisions
 * http://codex.wordpress.org/Writing_a_Plugin#Avoiding_Function_Name_Collisions
 */
class AtozsitesGoogleAnalytics {

	/**
	 * @var AtozsitesGoogleAnalytics - Static property to hold our singleton instance
	 */
...
$wp_google_analytics = AtozsitesGoogleAnalytics::get_instance();
